...
| Cloudflare version ID | pending deploy for CORS repair |
| Source commit | pending `cloudflare-production-2026-09-13-7` tag |
| Git tag | pending `cloudflare-production-2026-09-13-7` |
