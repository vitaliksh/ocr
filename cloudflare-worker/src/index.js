...
function normalizeRecord(raw) {
  ...
  const expense = kind === "expense_invoice", income = kind === "income_report", code = text(raw?.form_6111_code), mapped = expense && code ? RIVHIT_MAPPING[code] : null;
